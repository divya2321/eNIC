                ...
                <td width="350px" style="vertical-align:top;">
                    ...
                    <p>
                        <table>
							...
							<tr>
                                <td width="80">FakeLevel</td>
                                <td>
                                    <select size="1" id="DDb_FakeLevOpt" onchange="FakeLevOpt()">
                                        <option value="0">0</option>
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>
									...
									<label><input type="checkBox" id="Cb_EnDetectFakeAdvanced" onclick="EnDetectFakeAdvancedChecked();" /> Ex</label>
                                </td>
                            </tr>
                        </table>
                    </p>
