	...
	<div class="container">
	  		<div class="row">	  				
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					 	...
					 	<div class="form-group">
					    	<label for="healthrec">Health record:</label>
					    	<input type="text" class="form-control" id="healthrec">
					  	</div>		  	
				
					  	<div class="form-group">
					    	<label for="discription">Discription:</label>
					    	<textarea rows="5" class="form-control" id="discription"></textarea>
					  	</div>
					  	
					  	<div class="form-row">
					  		<div class="form-group">
						    	<label for="doctor">Doctor:</label>
						    	<input type="tel" class="form-control" id="doctor">
					  		</div>
